  ...
  return (
    <Card className="p-4 text-center">
      <CardHeader className="flex flex-col items-center">
        ...
        <h3>
          Your contribution helps us build a better crypto exchange platform.
        </h3>
      </CardHeader>
      <CardBody className="space-y-4 text-center">
        <p>
          We&apos;ve sent a confirmation to your email address. Your donation
          directly supports the development of innovative features and a
        ...
        <div className="rounded-lg bg-primary-50 p-4">
          <p className="text-muted-foreground text-sm">
            &ldquo;The future of finance is decentralized, and together, we are
            shaping it.&rdquo;
          </p>
          <p className="mt-2 text-sm font-medium">— CryptoCurrent Team</p>
        </div>
      </CardBody>
